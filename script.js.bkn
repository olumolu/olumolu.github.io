...
sendBtn.addEventListener('click', () => {
  ...
  if (userInputValue === '') {
    messages.push('<span style="color: blue;">You: ' + userInputValue + '</span><br><span style="color: green;"> >>> That is blank😅</span>');
  } else if (customResponse(userInputValue)) {
    messages.push('<span style="color: blue;">You: ' + userInputValue + '</span><br><span style="color: green;"> >>> ' + customResponse(userInputValue) + '</span>');
  } else {
    messages.push('<span style="color: blue;">You: ' + userInputValue + '</span><br><span style="color: green;"> >>> I didn\'t understand that. Can you please rephrase?</span>');
  }
